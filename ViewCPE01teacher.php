<?php
	session_start();
		...
		$_SESSION["Teacher_state_project"] = $STATE;
...
<!-------------------------------------------------------------------- CPE04 --------------------------------------------->
  <div class="<?php
		...
		else if($project[6]==6&&$project[6]<999)	
		{
			echo "circle fail";
		}
		else if($project[6]==7&&$project[6]<999)	
		{
			echo "circle wait";
		}	
		else if($project[6]==8&&$project[6]<999)	
		{
			echo "circle wait";
		}	
    ...
    <tfoot>
		...
		<?php
			...
			else
			{
				...
				{
					echo "<button  ripple-color='tealA400'  bg-Red500 onclick=\"confirm(999,".$ID.")\">ไม่ยืนยัน</button>";
					echo "<button  ripple-color='tealA400' bg-Green500 onclick=\"confirm(2,".$ID.")\">ยืนยัน</button>";
				}
...
//<center>
	//	<button bg-Red500 ripple-color="tealA400" bg-Green500 onclick="confirm(999,<?php echo $ID;?>)">ไม่ยืนยัน</button>
	//	<button bg-Red500 ripple-color="tealA400" bg-Red500 onclick="confirm(2,<?php echo $ID;?>)">ยืนยัน</button>
		//</center>
function confirm(status,id)
{	
		
		$.getJSON('UpdateCPE01.php?id='+id+"&status="+status, function(jd) {
				
		
		  window.location.replace("ViewCPE01teacher.php?id="+id);
              });
	...
	<div fluid card bg-Grey500="">
        ...
        <div align=right>
		<font color="white"> Page ID : 9 CPE 01 </font>
		</div>
