<?php
	session_start();
		...
		$query_CPE07 = mysql_query ("SELECT * FROM `CPE07` WHERE ID_project = '".$ID."'  ");
...
<h4>รายชื่อนิสิตผู้ทำโครงงาน</h4>
    ...
    <tfoot>
			...
			<form name="formdata" id="formdata" onsubmit="return required()" method="post" action="saveCPE07.php?id=<?php echo $ID;?>" >
 ...
 function required()
{
	...
	<div fluid card bg-Grey500="">
		...
		<div align=right>
		<font color="white"> Page ID : 11 CPE 07 </font>
		</div>
