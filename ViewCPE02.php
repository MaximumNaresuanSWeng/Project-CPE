<?php
	session_start();
		...
		$query_CPE02 = mysql_query ("SELECT * FROM `CPE02` WHERE ID_project = '".$_SESSION["ID_project"]."' ");
...
<div bg-grey100="" padded="">
 ...
 <div class="<?php
    ...
    <tbody>
		...
		{$number++;
		echo "<form id=\"".$CPE02[0]."\" action=\"UpdateCPE02New.php?id=".$CPE02[0]."\" method=\"post\">";
		...
		?>
			<tr>
				...
				<td><div align="center">
				<input type="text" name="subject0" value="<?php echo $CPE02[1];?>">
				</div></td>
				<td><div align="center">
				<input type="text" name="subject1" value="<?php echo $CPE02[2];?>">
				</div></td>
				<td><div align="center">
				<input type="text" name="subject2" value="<?php echo $CPE02[3];?>">
				</div></td>
				<td style="width: 200px"><div align="center">
				<input type="text" name="subject3" value="<?php echo $CPE02[4];?>">
				</div></td>
				<td style="width: 200px"><div align="center">
				...
				<?php 
					if($CPE02[5] == 1)
					{
						echo "<button bg-Red500 ripple-color='tealA400' \">Update</button>";
					}
					else
					{
						echo "ยืนยันแล้ว";
...
<hr>
	...
	<div fluid card bg-Grey500="">
		...
		<div align=right>
		<font color="white"> Page ID : 5 CPE 02 </font>
		</div>
	</div>
