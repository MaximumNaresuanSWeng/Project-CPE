...
<div bg-grey100="" padded="">
      ...
      <div fluid card bg-Orange500="" align-center>
		...
		<div card="" z-0="" align-center>
	     ...
	     <div bg-grey100="" padded="">
				...
				<button bg-Red500 ripple-color="tealA400" onclick="location.href='ViewCPE01Admin.php'">CPE01</button>
				
				<button bg-Red500 ripple-color="tealA400" onclick="location.href='ViewCPE02Admin.php'">CPE02</button>
				
				<button bg-Red500 ripple-color="tealA400" onclick="location.href='ViewCPE03Admin.php'">CPE03</button>
				
				<button bg-Red500 ripple-color="tealA400" onclick="location.href='ViewCPE04Admin.php'">CPE04</button>
		
				<button bg-Red500 ripple-color="tealA400" onclick="location.href='ViewCPE05Admin.php'">CPE05</button>
				
				<button bg-Red500 ripple-color="tealA400" onclick="location.href='ViewCPE06Admin.php'">CPE06</button>
				
				<button bg-Red500 ripple-color="tealA400" onclick="location.href='ViewCPE07Admin.php'">CPE07</button>
	...
	<div fluid card bg-Grey500="">
		...
		<div align=right>
		<font color="white"> Page ID : 5 CPE 05 </font>
		</div>
