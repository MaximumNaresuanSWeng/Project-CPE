<?php
	session_start();
		...
		$query_CPE06 = mysql_query ("SELECT * FROM `CPE06` WHERE ID_project = '".$_SESSION["ID_project"]."'  ");
...
<h4>รายชื่อนิสิตผู้ทำโครงงาน</h4>
	...
	<form name="formdata" id="formdata" onsubmit="return required()" method="post" action="#" >
			<hr>
			<h4>ความคิดเห็นของอาจารย์ที่ปรึกษา</h4>
	...
	<center>
	<?php
	if($dataquery_CPE06[3] == "13")
	{
		echo "เห็นสมควรให้สอบโครงงานได้";
	}
	else
	{
		echo "ยังไม่สมควรให้สอบโครงงาน";
	}
	?>
	</center>
	</td>
