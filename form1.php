...
<body>
	...
	<form action="saved.php" method="post">
		...
		อีเมล์
		<input type="text" name="mail3" size="20">
	...
	//$objResultteacher = mysql_fetch_array($objQueryteacher);
		...
		<?php
		$strSQLteacher2 = "SELECT * FROM teacher_detail";
		$objQueryteacher2 = mysql_query($strSQLteacher2);
	//$objResultteacher = mysql_fetch_array($objQueryteacher);
	
		while($objResultteacher2 = mysql_fetch_array($objQueryteacher2)){
		?>	
		<option value="<?php echo $objResultteacher2["teacherID"];
		?>"><?php echo $objResultteacher2["t_firstname"]."  ".$objResultteacher2["t_lastname"];?></option>
