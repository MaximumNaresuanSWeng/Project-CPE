...
<body>
	...
	<div id = "paneltab">
		...
		<div id = "paneltag2">
		<a href = "projectchoose.php"><center><h1>Project</h1></center></a>
		</div>
	...
	<div id = "panelbody">
		...
		<center><input type="submit" value="CPE04"></center>
		</form>
		<br>
		<form action="form5.php">
		<center><input type="submit" value="CPE05"></center>
		</form>
		<br>
		<form action="form6.php">
		<center><input type="submit" value="CPE06"></center>
		</form>
		<br>
		<form action="form7.php">
		<center><input type="submit" value="CPE07 แบบประเมินโครงการ"></center>
		</form> -->
		</div>
		<center>
		@copyright SuperStar<br>
		เป็นส่วนหนึ่งของรายวิชา 305351 Computer System Engineering<br>
		ภาคการศึกษาที่ 2 ปีการศึกษา 2557<br>
		</center>
	</div>
